<template>
    <div>
        ...
        <div v-else>
            <BasePicker v-if="editMode" searchApiPath="users" searchParameterName="email"  idField="id" nameField="email" path="users" label="UserId" v-model="value" @selected="pick" :editMode="editMode" />
